# RailsAdmin config file. Generated on December 18, 2012 00:59
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Canary Web', 'Admin']
  ...
  # config.excluded_models = [Attachment, Authentication, Banner, Comment, Order, Role, Room, RoomResource, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Attachment, Authentication, Banner, Comment, Order, Role, Room, RoomResource, User]
  ...
  #   # Found associations:
  #     configure :attachment, :has_one_association   #   # Found columns:
  #     configure :id, :integer 
  ...
  #     configure :id, :integer 
  #     configure :user_id, :integer         # Hidden 
  #     configure :room_id, :integer         # Hidden 
  #     configure :room_num, :integer 
  #     configure :order_name, :string 
  #     configure :order_phone, :string 
  #     configure :status, :string 
  #     configure :price, :integer 
  #     configure :checkin, :date 
  #     configure :checkout, :date 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime   #   # Sections:
  #   list do; end
  #   export do; end
  ...
  #   update do; end
  # end
  # config.model RoomResource do
  #   # Found associations:
  #   # Found columns:
  #     configure :id, :integer 
  #     configure :room_id, :integer 
  #     configure :day, :date 
  #     configure :total, :integer 
  #     configure :price, :integer 
